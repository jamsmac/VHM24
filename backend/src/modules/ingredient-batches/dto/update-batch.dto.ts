...
/**
 * DTO for updating an ingredient batch
 *
...
export class UpdateIngredientBatchDto {
  @ApiPropertyOptional({
    description: 'Batch number/identifier (unique per nomenclature)',
  ...
  @ApiPropertyOptional({
    description: 'Original quantity in the batch',
    example: 1000,
    minimum: 0.001,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Remaining quantity after deductions',
    example: 500,
    minimum: 0,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Date when the batch was received',
    example: '2026-01-04',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    example: 'Updated notes about the batch',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    example: { certificate: 'CERT-002', quality_grade: 'A+' },
  })
  @IsOptional()
