...
import { TelegramLanguage, TelegramUser } from '../../shared/entities/telegram-user.entity';
import { TaskStatus, TaskType } from '../../../tasks/entities/task.entity';
import { UserRole } from '../../../users/entities/user.entity';
import { TelegramTaskInfo, TelegramMachineInfo } from '../../shared/types/telegram.types';
