...
```
VHM24/
├── backend/                 # NestJS API (924 файла TypeScript)
├── frontend/                # Next.js Dashboard (233 компонента)
├── mobile/                  # React Native App (19 компонентов)
├── docs/                    # Документация
...
├── components/                # 20 директорий компонентов
